...
const Privacy = () => (
	<div>
	    ...
	    <h4>Introduction</h4>
	    <p>
	        Thank you for visiting <a href="/">getmyhealthcare.com</a> a website run by <a href="http://blipmarketing.co" target="_blank">Blip Marketing</a>. Blip Marketing ("we", "us") is committed to protecting the privacy of your personally identifiable information. We provide this privacy policy ("Privacy Policy") in order to explain our online information practices and the choices you can make about the way we use your information. To use this website ("Site"), you must agree to this Privacy Policy, in its entirety, including our use of cookies. Your acceptance of both this Privacy Policy and our use of cookies on the Site shall be deemed a blanket acceptance of such Privacy Policy and cookie usage. If you do not agree to this Privacy Policy in its entirety, you are not authorized to use this Site. This Privacy Policy is part of the <a href="terms.php" target="_blank">Terms of Use</a> ("Terms") for this Site.
	    </p>
	    <h4>Personally Identifiable Information</h4>
	    <p>
	        We collect personally identifiable information when you provide it through our form on this or any of our Sites. Personally identifiable information is any information that can be used to identify or locate a particular person or entity. This may include, but is not limited to: your name, contact information, and information about your job needs. For purposes of this Privacy Policy, your account information shall be considered "Sensitive Information," and will only be shared with our <a href="http://blipmarketing.co/partners.php#health" target="_blank">partners</a> for purposes of offering you information about health insurance services or other information you have requested.
	    </p>
	    ...
	    <p>
	        We use Cookies and Web Beacons to enhance your experience with the Site. You are not authorized to use the services offered on this Site if you do not agree to our use of cookies. For more specific information on the cookies we use, please contact us at <a href="mailto:privacy@blipmarketing.co">privacy@blipmarketing.co</a>. Cookies are small packets of data stored on your computer. Cookies are used by your computer's browser to store your preferences. Cookies, by themselves, do not tell us your e-mail address or other personally identifiable information. We use cookies to understand Site usage and to improve the content and offerings on the Site. You may set your browser to warn you that cookies are in use, or to block the use of cookies. Most browsers are set to accept cookies. If your browser is not set to accept cookies, certain uses of the Site may require you to go to your browser user preferences to enable cookies. Each browser is different, so check the "Help" menu of your browser to learn how to change your cookie preferences. If you change computers, operating systems or browsers, or use multiple computers or browsers, you will need to repeat this process for each computer and each browser. To find out more about cookies (and other kinds of online tracking), please visit <a href="www.consumer.ftc.gov/articles/0042-online-tracking" target="_blank">www.consumer.ftc.gov/articles/0042-online-tracking</a>  We may additionally collect information using Web beacons, which are commonly referred to in the industry as web bugs, pixel tags or Clear GIFs. Web beacons are electronic images that may be used on the Site, or in our emails to deliver cookies, count visits and determine if an email has been opened and acted upon.
	    </p>
	    <h4>Use of Information</h4>
	    <p>
	        We use your personally identifiable information: (a) to offer you information about insurance services and other information you have requested; (b) to track your compliance with the Terms; and/or (c) for validation, suppression, content improvement and feedback purposes.
	    </p>
	    ...
	    <h4>Opting Out of Receiving E-mail</h4>
	    <p>
	        You may at any time choose to stop receiving emails containing general information regarding health insurance assistance by following the instructions at the end of each such email or by contacting <a href="mailto:privacy@blipmarketing.co">privacy@blipmarketing.co</a>. Should you be contacted by us through email, you can follow the instructions at the end of each such email to stop receiving such emails. There may be a short delay of up to several business days while your request is being verified, deployed and processed across our servers. Notwithstanding the foregoing, we may continue to contact you for the purpose of responding to any inquiry or request made by you.
	    </p>
