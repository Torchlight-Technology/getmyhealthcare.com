...
const Terms = () => (
	<div class="content-page">
	    ...
	    <ul>
	        <li>We take your privacy very seriously. See our <a href="privacy" target="_blank">Privacy Policy</a>.</li>
	        <li>By taking action to request information, accept terms, or submit information, you are consenting to certain contact from Blip Marketing and our partners.(<a href="#section2">Section 2</a>)</li>
	        <li>Blip Marketing is not liable for your activities and makes no warranties with respect to our sites. (<a href="#section10">Section 10</a>)</li>
	        <li>You agree to arbitrate in your individual capacity if there is a dispute between us. (<a href="#section14">Section 14</a>)</li>
	        <li>Please do not hesitate to <a href="#section21">contact us</a> if you have questions or need help.</li>
	    </ul>
	    <h4 id="section1">1. About These Terms of Use.</h4>
	    <p>
	    ...
	    <p>
	        <strong>Notice Regarding Dispute Resolution: These Terms contain provisions that govern how disputes between you and Blip Marketing are resolved, including an agreement to arbitrate, which will, with limited exception, require you to submit claims you have against us to binding and final arbitration and limit you to claims against Blip Marketing on an individual basis. </strong>
	    </p>
	    <h4 id="section2">2. Consent and Privacy.</h4>
	    <p>
	    ...
	    <p>
	        When you use the Site to make a submission, you agree to allow the Site, Blip Marketing, and our affiliates to add your telephone number and email address to our database of users. You may receive one or more marketing calls or emails from the Site, Blip Marketing and/or our affiliates. You may opt not to receive such marketing emails from us at any time. Please review our <a href="privacy" target="_blank">Privacy Policy</a> for more information regarding our information collection practices and safeguards, and how to opt not to receive such emails. Your use of the Site signifies your acknowledgement of and agreement with our <a href="privacy" target="_blank">Privacy Policy</a>, which is expressly incorporated into these Terms.
	    </p>
	    <p>
	    ...
	    <h4 id="section3">3. Our Services.</h4>
	    <p>
	    ...
	    <h4 id="section4">4. Personal Use.</h4>
	    <p>
	    ...
	    <h4 id="section5">5. Proprietary Rights and Downloading of Information from the Site.</h4>
	    <p>
	    ...
	    <h4 id="section6">6. Unauthorized Use.</h4>
	    <p>
	    ...
	    <h4 id="section7">7. Changes to Site.</h4>
	    <p>
	    ...
	    <h4 id="section8">8. Data Transmittal.</h4>
	    <p>
	    ...
	    <h4 id="section9">9. Identity Verification.</h4>
	    <p>
	    ...
	    <h4 id="section10">10. Limitation of Liability.</h4>
	    <p>
	    ...
	    <h4 id="section11">11. Disclaimer of Warranties.</h4>
	    <p>
	    ...
	    <h4 id="section13">13. Indemnity.</h4>
	    <p>
	    ...
	    <h4 id="section14">14. Dispute Resolution.</h4>
	    ...
	    <p><strong>Forum for Certain Disputes that Are Not Arbitrated</strong></p>
	    <p>
	    ...
	    <h4 id="section15">15. No Agency.</h4>
	    <p>
	    ...
	    <h4 id="section17">17. Amendments.</h4>
	    <p>
	    ...
	    <h4 id="section18">18. Copyright Infringement.</h4>
	    <p>
	    ...
	    <p>
	        For clarity, only DMCA notices should go to the Copyright Agent; any other feedback, comments, requests for technical support, and other communications should be directed to Blip Marketing's customer service <a href="mailto:info@blipmarketing.co">info@blipmarketing.co</a>.
	    </p>
	    <h4 id="section19">19. Links to Third-Party Sites.</h4>
	    <p>
	        This Site may contain links and pointers to other Internet sites that are not owned or controlled by Blip Marketing. Blip Marketing has no control over, and assumes no responsibility for the products, services, content, privacy policies or practices of any third-party website or application. Links to and from the Site to other sites, maintained by third parties, do not constitute an endorsement by us of such third-party sites or the contents, products or services thereof. You expressly relieve Blip Marketing from any and all liability arising from your use of any linked third-party website or application. Accordingly, we encourage you to be aware when you leave our Site and to read the terms and conditions and <a href="privacy" target="_blank">Privacy Policy</a> of each website or application that you access or use.
	    </p>
	    <h4 id="section20">20. Miscellaneous.</h4>
	    ...
	    <h4 id="section21">21. Feedback and Questions.</h4>
	    <p>
	        We welcome your comments, feedback, suggestions, and other communications regarding the Site and the information and services we make available through the Site (collectively, "Feedback"). Please contact us with Feedback at <a href="mailto:info@blipmarketing.co">info@blipmarketing.co</a>. Please note our separate address for legal correspondence, above.
	    </p>
	    <p>
